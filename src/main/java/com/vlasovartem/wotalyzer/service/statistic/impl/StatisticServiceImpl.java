...
public class StatisticServiceImpl implements StatisticService {
    ...
    @Autowired
    public StatisticServiceImpl(TankUtils tankUtils, VehicleProfileUtils vehicleCharacteristicUtils, VehiclesService vehiclesService, VehicleService vehicleService, VehicleModuleInfoRepository vehicleModuleInfoRepository) {
