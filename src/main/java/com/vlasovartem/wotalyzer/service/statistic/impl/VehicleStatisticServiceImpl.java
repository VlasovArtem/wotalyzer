...
import com.vlasovartem.wotalyzer.entity.wot.api.tankopedia.components.provision.ammo.Ammo;
...
@Service
public class VehicleStatisticServiceImpl implements VehicleStatisticsService {

    private final static Logger LOGGER = LogManager.getLogger(VehicleStatisticsService.class);
    ...
    @Autowired
    public VehicleStatisticServiceImpl(TankUtils tankUtils, VehicleProfileUtils vehicleProfileUtils, VehiclesService vehiclesService, VehicleService vehicleService, VehicleModuleInfoRepository vehicleModuleInfoRepository) {
    ...
    /**
     * Collect Statistic of the best Weight/Ton Ration for particular list of vehicles
     *
     * @param statistic        Statistic object that should update by collected data
     ...
     * @return return Statistic object with update content.
     */
    private Statistic<Double> collectBestVehicleDynamic(Statistic<Double> statistic, List<Vehicles> searchedVehicles, boolean ignorePremium) {
        ...
        throw new RuntimeException("Statistic and searchable vehicles cannot be null");
    }
